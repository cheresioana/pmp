...
1. Schema
   ...
   - dupa ce generatorul a determinat probabilitatea, pe baza acestuia se calculeaza separat recalcularea weightu-urilor separat in cele doua retele neuronale
